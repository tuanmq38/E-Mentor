        ...
        <section class="main">
            ...
            static function listMentors(array $mentors)
            {
                ...
                <div class="row align-items-center" style="margin-top: 120px;">
                    <div class="col">
                        <img class="rounded" src="images/mentoring.png" alt="banner" style="width: 900px;">
                    </div>
                    <div class="col">

                        <h3 class="text-left" style="margin-top: 60px; margin-bottom: 60px; ">List of Mentors</h3>
                        <table class="table">
                            ...
                            foreach ($mentors as $mentor) {
                                ...
                                if ($mentor->getMentor_schedule_date() > $currentDate) {
                                    echo "<td> <div class=\"bg-success text-white\">" . "Available" . "</div></td>";
                                    $mentorID = "?mentor_id=" . $mentor->getMentor_id();
                                    $link = "Mentee_booking.php";
                                    echo "<td><a href=\"" . $link  . $mentorID . "\">Book</td>";
                                } else
                                    echo "<td> <div class=\"bg-secondary text-white\">" . "Overdue" . "</div></td>";
